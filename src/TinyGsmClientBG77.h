...
#ifndef SRC_TINYGSMCLIENTBG77_H_
#define SRC_TINYGSMCLIENTBG77_H_
// #pragma message("TinyGSM:  TinyGsmClientBG77")
...
class TinyGsmBG77 : public TinyGsmModem<TinyGsmBG77>,
                    public TinyGsmGPRS<TinyGsmBG77>,
                    public TinyGsmTCP<TinyGsmBG77, TINY_GSM_MUX_COUNT>,
                    public TinyGsmCalling<TinyGsmBG77>,
                    public TinyGsmSMS<TinyGsmBG77>,
                    public TinyGsmTime<TinyGsmBG77>,
                    public TinyGsmNTP<TinyGsmBG77>,
                    public TinyGsmGPS<TinyGsmBG77>,
                    public TinyGsmBattery<TinyGsmBG77>,
                    public TinyGsmTemperature<TinyGsmBG77> {
  friend class TinyGsmModem<TinyGsmBG77>;
  friend class TinyGsmGPRS<TinyGsmBG77>;
  friend class TinyGsmTCP<TinyGsmBG77, TINY_GSM_MUX_COUNT>;
  friend class TinyGsmCalling<TinyGsmBG77>;
  friend class TinyGsmSMS<TinyGsmBG77>;
  friend class TinyGsmTime<TinyGsmBG77>;
  friend class TinyGsmNTP<TinyGsmBG77>;
  friend class TinyGsmGPS<TinyGsmBG77>;
  friend class TinyGsmBattery<TinyGsmBG77>;
  friend class TinyGsmTemperature<TinyGsmBG77>;

  /*
   * Inner Client
   */
 public:
  class GsmClientBG77 : public GsmClient {
    friend class TinyGsmBG77;

   public:
    GsmClientBG77() {}

    explicit GsmClientBG77(TinyGsmBG77& modem, uint8_t mux = 0) {
      init(&modem, mux);
    }

    bool init(TinyGsmBG77* modem, uint8_t mux = 0) {
      this->at       = modem;
      sock_available = 0;
      prev_check     = 0;
  ...
  /*
  class GsmClientSecureBG77 : public GsmClientBG77
  {
  public:
    GsmClientSecure() {}

    GsmClientSecure(TinyGsmBG77& modem, uint8_t mux = 0)
  ...
  */
   ...
   */
 public:
  explicit TinyGsmBG77(Stream& stream) : stream(stream) {
 ...
 protected:
  bool initImpl(const char* pin = NULL) {
    ...
    DBG(GF("### TinyGSM Compiled Module:  TinyGsmClientBG77"));
 ...
 protected:
  ...
  // The BG77 returns UTC time instead of local time as other modules do in
 ...
 protected:
  GsmClientBG77* sockets[TINY_GSM_MUX_COUNT];
  const char*    gsmNL = GSM_NL;
};

#endif  // SRC_TINYGSMCLIENTBG77_H_
